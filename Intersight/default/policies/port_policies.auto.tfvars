...
port_policies = {
  "domainx-a" = {
    description  = "domainx Port Policy"
    device_model = "UCS-FI-6454"
    port_channel_appliances = {}
    port_channel_ethernet_uplinks = {
      "49" = {
        admin_speed                     = "Auto"
        ethernet_network_group_policy   = "domainx"
        flow_control_policy             = "domainx"
        interfaces = [
          {
            port_id          = 49
            slot_id          = 1
        ...
        link_aggregation_policy = "domainx"
        link_control_policy     = "domainx"
      }
    }
